...
Start the program.
Read integers.
Create an adjacency list graph of size n.
Build the Graph.
Read Start and Target.
Initialize BFS.
Initialize DFS
Counting Reachable Attractions and Print.
End the program. 
...
## Output:
<img width="812" height="248" alt="image" src="https://github.com/user-attachments/assets/68140c49-cbbe-4506-8bf3-015bdaebbcf5" />
