...
Read n integers and store them in array.
Building the Tree (Level-Order).
Counting Left Subtree Nodes.
Print the result.
Stop the program.  
...
<img width="538" height="350" alt="image" src="https://github.com/user-attachments/assets/6e86b1d5-349d-49d9-95a1-53f165618cf9" />
